...
from services.telegram_bot.utils.constants import UPDATE_PROJECT_PREFIX
from services.telegram_bot.utils.database import get_user_projects_from_airtable, get_project_updates_from_airtable, format_project_summary_text
