...
from services.telegram_bot.utils.constants import UPDATE_PROJECT_PREFIX, VIEW_PROJECT_PREFIX
from services.telegram_bot.utils.database import get_user_projects_from_airtable
